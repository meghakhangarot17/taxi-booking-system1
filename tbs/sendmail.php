...
if(isset($_POST['email'])) {
 ...
 /*
    ...
    $email_from = "sanjaykumarbhupathi0623@gmail.com"; // required
    ...
    $email_message = " This is an email form Taxi  Management to confirm your vehicle. Details are given below.\n\n";
        ...
        <div class="row">
            ...
            <div class="col-md-6">
               <br><br><br><br><br>
                ...
                <a class="btn btn-default" href="bill.php?id=<?php echo $id?>">Go Back</a>
            </div>
            <div class="col-md-3"></div>
        </div>
    </div>
